...
from game import SnakeGameIA, Directionn, Point
...
class Agent:
	...
	def __init__(self):
		...
		self.gamma = 0.9
		self.memory = deque(maxlen=MAX_MIMORY)
		self.model = Linear_QNet(11, 250, 3) # TODO
	...
	def get_action(self, state):
		...
		#random moves: tradeoff exploration / expliotation
